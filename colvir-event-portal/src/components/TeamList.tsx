    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
      ...
      <div className="bg-white rounded-3xl p-6 border border-slate-200/80 shadow-xs space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
          <div>
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-accent-light text-accent text-xs font-extrabold uppercase tracking-wider mb-2">
              ...
              return (
                <button
                  ...
                  className={`flex items-center gap-2 px-4 py-2.5 rounded-2xl text-xs font-bold whitespace-nowrap transition-all border ${
                    isActive
                      ? 'bg-accent border-accent text-white shadow-xs ring-2 ring-accent/20'
        ...
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm placeholder-slate-400 focus:bg-white focus:border-accent focus:ring-2 focus:ring-accent/20 transition-all"
          />
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
              {filteredTeams.map((team) => {
                ...
                return (
                  <div
                    key={team.id}
                    className="bg-white rounded-3xl border border-slate-200/80 shadow-xs hover:border-accent/40 transition-all flex flex-col overflow-hidden"
                  >
                    {/* Team Header */}
                    <div className="p-5 bg-gradient-to-r from-accent-light to-slate-50 border-b border-slate-100 flex items-center justify-between">
                      ...
                      <span className="px-3 py-1 bg-accent text-white text-xs font-extrabold rounded-xl shadow-2xs">
                  ...
                  {filteredSoloParticipants.map((p, idx) => (
                    <tr key={p.id} className="hover:bg-slate-50/80 transition-colors">
                      ...
                      <td className="py-3.5 px-4 font-bold text-accent">
                        <span className="px-2.5 py-1 bg-accent-light border border-accent/20 rounded-lg">
