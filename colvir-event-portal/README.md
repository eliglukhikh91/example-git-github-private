...
## Акцентный цвет и праздничные темы

Оформление (классическая тема и три праздничных) переключается свотчами в меню
профиля в сайдбаре — тема применяется сразу, без отдельного окна.

Акцентный цвет вынесен в theme-переменные Tailwind в `src/index.css`:
